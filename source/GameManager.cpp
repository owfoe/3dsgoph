...
void GameManager::gameModeUpdate()
{
    ...
    if (kDown & KEY_DOWN)
        gameModeSelect = (gameModeSelect + 1) % ProjectSettings::GAME_MODE_COUNT;

    if (kDown & KEY_UP)
        gameModeSelect = (gameModeSelect - 1 + ProjectSettings::GAME_MODE_COUNT) % ProjectSettings::GAME_MODE_COUNT;
